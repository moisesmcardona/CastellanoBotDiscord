...
Public Class Form1
    ...
    Private DiscordChannelObject As DiscordGuild
    ...
    Private GeneralChannel As ULong = 356431146986373132
    ...
    Private Async Function OnGuildMemberAdd(ByVal e As GuildMemberAddEventArgs) As Task Handles DiscordClient.GuildMemberAdded
        Dim Channel As DiscordChannel = Await DiscordClient.GetChannelAsync(373901940859600897)
        Dim MentionComandosChannel As DiscordChannel = Await DiscordClient.GetChannelAsync(364574672995614721)
        Await DiscordClient.SendMessageAsync(Channel, e.Member.Mention & ", bienvenido al chat de HispanoHablantes." + Environment.NewLine + "Utiliza el comando !bot para saber mis comandos en " & MentionComandosChannel.Mention & " :slight_smile:. ¡También recuerda votar a @moisesmcardona, @castellano y tus witnesses favoritos!")
    End Function
    ...
    Private Async Function OnMessage(ByVal e As MessageCreateEventArgs) As Task Handles DiscordClient.MessageCreated
        ...
        If e.Message.Author.Username = "HispanoHablantesBot" = False Then
            If e.Channel.Id = 356431146986373132 Or e.Channel.Id = 364574672995614721 Then '#general
                ...
                If e.Message.Content.ToLower().Contains("!bot") Or e.Message.Content.ToLower().Contains("!help") Or e.Message.Content.ToLower().Contains("!ayuda") Then
                    ...
                    Await Message.SendMessageAsync("Hola, soy un bot creado por " & MentionMoises.Mention & vbCrLf & vbCrLf & "Mis comandos son los siguientes: " & vbCrLf &
                                       ...
                                       MentionMoises.Mention & " es un Witness. Si te gusta este bot y sus proyectos, considera votándolo como Witness :slight_smile:")
                    Threading.Thread.Sleep(500)
                ...
                ElseIf e.Message.Content.ToLower().Contains("!seguidores") Then
                    ...
                    If IsUserInDiscord Then
                        Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", tienes " & FollowerNumber & " seguidores :slight_smile:  ")
                    Else
                        Await e.Channel.SendMessageAsync("@" & User & " tiene " & FollowerNumber & " seguidores :slight_smile:  ")
                    End If
                ElseIf e.Message.Content.ToLower().Contains("!siguiendo") Then
                    ...
                    If IsUserInDiscord Then
                        Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", sigues a " & FollowingNumber & " perfiles :slight_smile:  ")
                    Else
                        Await e.Channel.SendMessageAsync("@" & User & " sigue a " & FollowingNumber & " perfiles :slight_smile:  ")
                    End If
                ElseIf e.Message.Content.ToLower().Contains("!ubicación") Or e.Message.Content.ToLower.Contains("!ubicacion") Then
                    ...
                    If IsUserInDiscord Then
                        Await e.Channel.SendMessageAsync(UserInDiscord.Mention & " es de " & location & " :slight_smile: ")
                    Else
                        Await e.Channel.SendMessageAsync("@" & User & " es de " & location & " :slight_smile: ")
                    End If
                ElseIf e.Message.Content.ToLower().Contains("!posts") Then
                    Dim postNumber As Integer = GetResultFromSteemPlaceAPI(User, "posts")
                    If IsUserInDiscord Then
                        Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", tienes " & postNumber & " posts y comentarios combinados :slight_smile: ")
                    Else
                        Await e.Channel.SendMessageAsync("@" & User & " tiene " & postNumber & " posts y comentarios combinados :slight_smile: ")
                    End If
                ElseIf e.Message.Content.ToLower().Contains("!creacion") Or e.Message.Content.ToLower().Contains("!creación") Or e.Message.Content.ToLower().Contains("!registro") Then
                    ...
                    If IsUserInDiscord Then
                        Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", tu cuenta fue creada el " & FullDate & " a las " & DateAndTime.ToString("hh:mm:ss tt") & " :slight_smile: ")
                    Else
                        Await e.Channel.SendMessageAsync("La cuenta de @" & User & " fue creada el " & FullDate & " a las " & DateAndTime.ToString("hh:mm:ss tt") & " :slight_smile: ")
                    End If
                ElseIf e.Message.Content.ToLower().Contains("!sbd") Then
                    Dim Balance As String = GetResultFromSteemPlaceAPI(User, "sbd")
                    If IsUserInDiscord Then
                        Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", tienes " & Balance & " :slight_smile: ")
                    Else
                        Await e.Channel.SendMessageAsync("@" & User & " tiene " & Balance & " :heart: ")
                    End If
                ElseIf e.Message.Content.ToLower().Contains("!steem") Then
                    ...
                    If IsUserInDiscord Then
                        Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", tienes " & Balance & " :slight_smile: ")
                    Else
                        Await e.Channel.SendMessageAsync("@" & User & " tiene " & Balance & " :slight_smile: ")
                    End If
                    ...
                    If String.IsNullOrEmpty(WitnessVotes) = False Then
                        If WitnessVotes.Contains("moisesmcardona") Then
                            If IsUserInDiscord = True Then
                                Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", has votado a " & MentionMoises.Mention & " como Witness :heart: ")
                            Else
                                Await e.Channel.SendMessageAsync(User & " ha votado a " & MentionMoises.Mention & " como Witness :heart: ")
                            End If
                        Else
                            If IsUserInDiscord = True Then
                        ...
                        If WitnessVotes.Contains("castellano") Then
                            If IsUserInDiscord = True Then
                                Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", has votado a @castellano como Witness :heart: ")
                            Else
                                Await e.Channel.SendMessageAsync(User & " ha votado a @castellano como Witness :heart: ")
                            End If
                        Else
                            If IsUserInDiscord = True Then
                                Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", no has votado a @castellano como Witness :cry: Vótalo usando el siguiente enlace: https://v2.steemconnect.com/sign/account-witness-vote?witness=castellano&approve=1")
                            Else
                                Await e.Channel.SendMessageAsync(User & " no ha votado a @castellano como Witness :cry:")
                            End If
                        End If
                        Threading.Thread.Sleep(1100)
                        If WitnessVotes.Contains("dropahead") Then
                            If IsUserInDiscord = True Then
                                Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", has votado a @dropahead como Witness :heart: ")
                            Else
                                Await e.Channel.SendMessageAsync(User & " ha votado a @dropahead como Witness :heart: ")
                            End If
                        Else
                            If IsUserInDiscord = True Then
                                Await e.Channel.SendMessageAsync(UserInDiscord.Mention & ", no has votado a @dropahead como Witness :cry: Vótalo usando el siguiente enlace: https://v2.steemconnect.com/sign/account-witness-vote?witness=dropahead&approve=1")
                            Else
                                Await e.Channel.SendMessageAsync(User & " no ha votado a @dropahead como Witness :cry:")
                            End If
                        End If
                    End If
            ...
            '369214082349268992 = #bienvenida
            '368583801154306058 = #reportes
            If e.Channel.Id = 368568796216295434 = False And e.Channel.Id = 405907266663874562 = False And e.Channel.Id = 407348378570194947 = False And e.Channel.Id = 384876428065374210 = False And e.Channel.Id = 369214082349268992 = False And e.Channel.Id = 368583801154306058 = False Then
    ...
    End Function
    Private Function IsSteemitDown()
        Dim ResponseFromServer As String = String.Empty
        Dim SteemitDown As Boolean = False
        Try
            Dim request As System.Net.WebRequest = System.Net.WebRequest.Create("https://steemit.com")
            Dim response As System.Net.WebResponse = request.GetResponse()
            ...
            If String.IsNullOrEmpty(ResponseFromServer) = True Then
                SteemitDown = True
            Else
                SteemitDown = False
            End If
...
":police_car: :rotating_light: :police_car: :rotating_light: :police_car: :rotating_light: :police_car: :rotating_light: :police_car: :rotating_light: :police_car: :rotating_light: " & vbCrLf &
":warning: Por favor, escribe para confirmar que viste la advertencia :warning: Infracciones múltiples resultarán en tu expulsión de este servidor."
        Await DiscordClient.SendMessageAsync(Await DiscordClient.GetChannelAsync(356431146986373132), Message)
    End Sub

    Private Async Sub Button3_Click(sender As Object, e As System.EventArgs) Handles Button3.Click
        Await DiscordClient.SendMessageAsync(Await DiscordClient.GetChannelAsync(356431146986373132), TextBox1.Text)
    End Sub
End Class
